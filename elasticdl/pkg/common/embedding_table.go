...
type EmbeddingTable struct {
	Dim              int64
	Initializer      string
	EmbeddingVectors map[int64]*proto.Tensor
...
func NewEmbeddingTable(dim int64, initializer string, dtype proto.ElementType) *EmbeddingTable {
	var e = EmbeddingTable{
		...
		EmbeddingVectors: make(map[int64]*proto.Tensor),
		Dtype:            dtype,
	}
	return &e
}
...
func (e *EmbeddingTable) GetEmbeddingVectors(indices []int64) *proto.Tensor {
